$(document).ready(function () {
               ...
               document.getElementById("mensaje").innerHTML = "<strong>Reglas: </strong><br>";
    ...
    $.ajax({
        ...
        success: function (resp) { debugger
            if((resp.dsSolicitudVacaciones.eeEstados[0].Estado)=="OK")
            {
                ...
                if (resp.dsSolicitudVacaciones.eenotfregla)
                {
                    for(var i = 0; i < resp.dsSolicitudVacaciones.eenotfregla.length; i++ )
                    {
                        var index=i+1;
                     document.getElementById("mensaje").innerHTML += index+". "+resp.dsSolicitudVacaciones.eenotfregla[i].reglades+"<br>" ;  
