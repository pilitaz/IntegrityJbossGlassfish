...
function loadCampos() {
    ...
    document.getElementById('labelTexto').innerHTML = "En esta pantalla podrás escoger uno a uno los campos que " +
            "quieres ver en tu reporte. Para encontrar los campos, " +
            "deberás buscarlos escogiendo primero la categoría a la que " +
            "corresponde dentro del índice. ";
